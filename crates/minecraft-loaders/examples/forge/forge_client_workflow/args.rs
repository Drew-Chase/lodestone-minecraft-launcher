//! Full Forge client workflow example for Args Era Forge (MC 1.17-1.20.2).
//!
//! This example demonstrates the complete workflow for setting up and running
//! an Args Era Forge Minecraft client (1.20.1):
...
//!
//! **KNOWN LIMITATION**: The Args Era (1.17-1.20.2) uses a complex module-path
//! based launch configuration that requires additional setup not yet implemented.
//! The client installation works, but launching fails with module-related errors.
//! Legacy Forge (≤1.16.5) works correctly.
//!
//! Run with: cargo run --example forge_client_workflow_args
