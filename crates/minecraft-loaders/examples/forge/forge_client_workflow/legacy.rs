//! Full Forge client workflow example for Legacy Forge (MC ≤1.16.5).
//!
//! This example demonstrates the complete workflow for setting up and running
//! a Legacy Forge Minecraft client (1.12.2):
...
//!
//! Note: This will attempt to launch the Minecraft client with full GUI.
//! The launch will fail with "Missing required option(s) [accessToken]" because
//! no authentication is provided. This is expected behavior - in a real launcher,
//! you would provide auth credentials from Microsoft authentication.
//!
//! Run with: cargo run --example forge_client_workflow_legacy
