...
const activeAccent = "#22ff84";

type Theme = {id: string; name: string; bg: string; active?: boolean};
...
type Font = {name: string; desc: string; active?: boolean};
...
export default function AppearancePane() {
    return (
        <>
                ...
                <div className="grid grid-cols-3 gap-2.5">
                    {themes.map((t) => (
                        <div
                            ...
                            style={{
                                background: t.bg,
                                borderColor: t.active ? "var(--mc-green)" : "var(--line)",
                        ...
                        >
                            ...
                            <div
                                ...
                                style={{top: 24, left: 10, background: activeAccent}}
                            />
                            {/* Mock content panel */}
                            <div
            ...
            {/* Animation toggles live in a row-only card (no title) so it reads as a
                continuous list. */}
            <Card
                ...
                <div className="grid grid-cols-2 gap-2.5">
                    {fonts.map((f) => (
                        <div
                            ...
                            style={{
                                borderColor: f.active ? "var(--mc-green)" : "var(--line)",
