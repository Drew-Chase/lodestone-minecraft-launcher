...
import {findInstanceBySlug, cardSurfaceStyle} from "../components/library/instances";
    ...
    return (
        <div className="flex flex-col flex-1 min-w-0 min-h-0 bg-bg-0">
            ...
            <div className="flex-1 overflow-y-auto px-7 pt-5 pb-10">
                ...
                {tab === "logs" && <LogsTab/>}
                {(tab === "worlds" || tab === "settings") && (
                    <Card
                        className="p-10 text-center text-ink-3 border border-line"
                    ...
                    >
                        ...
                        <div className="text-xs">
                            Tab content placeholder — not the focus of this review.
                        </div>
                    </Card>
                )}
            </div>
