...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            instances::install_mod_version,
            instances::replace_mod_version,
            instances::get_installed_mods_info,
            instances::import_modpack,
            instances::install_modpack_from_discover,
            instances::list_recent_imports,
            instances::reimport_modpack,
